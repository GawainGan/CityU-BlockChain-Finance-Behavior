...
| # | 文档 | 协议/基础设施 | 链接 |
|---|------|-------------|------|
| 1 | Aave V3 | DeFi 借贷协议（主协议） | `01_Aave_V3.md` |
| 2 | Compound III | DeFi 借贷协议（跨协议验证） | `02_Compound_III.md` |
| 3 | MakerDAO / Sky | DeFi 借贷协议（外部有效性） | `03_MakerDAO_Sky.md` |
| 4 | Chainlink Oracle | 预言机基础设施 | `04_Chainlink_Oracle.md` |
| 5 | Ethereum Finality | 共识与最终性 | `05_Ethereum_Finality.md` |
| 6 | Dune Analytics | 数据查询平台 | `06_Dune_Analytics.md` |
